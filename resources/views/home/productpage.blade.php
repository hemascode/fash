...
<body>
                ...
                <div class="col-12">
                    <div class="offcanvas_menu_wrapper">
                        ...
                        <div class="header_contact_info">
                            <ul class="d-flex">
                                <li class="text-white"> <i class="icons icon-phone"></i> <a href="tel:+05483716566">+0000000</a></li>
                                <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a
                                        href="#">info@gmail.com</a></li>
                            </ul>
                        </div>
                        ...
                        <div id="menu" class="text-left ">
                            <ul class="offcanvas_main_menu">
                                ...
                                <li class="menu-item-has-children">
                                    <a href="/womenpage">Shop</a>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="/womenpage"> Product Details</a>
                                </li>
                                <li><a href="/womenpage">sale</a></li>
                                <li class="menu-item-has-children">
                                    <a href="/womenpage">pages </a>
                                    <ul class="sub-menu">
                                        <li><a href="/womenpage">cart</a></li>
                                        <li><a href="/womenpage">Checkout</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="/womenpage">blog</a>
                                    <ul class="sub-menu">
                                        <li><a href="/womenpage">blog</a></li>
                                        <li><a href="/womenpage">blog details</a></li>
                                    </ul>
    
                                </li>
                                <li><a href="/womenpage">buy</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="mini_cart">
        <div class="cart_gallery">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="refash/public/product-details.html"><img src="home/uthr/assets/img/product/product1.jpg" alt=""></a>
                </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="refash/public/product-details.html"><img src="home/uthr/assets/img/product/product2.jpg" alt=""></a>
                </div>
                <div class="cart_info">
    ...
    <header class="header_section header_transparent">
                            ...
                            <div class="header_contact_info">
                                <ul class="d-flex">
                                    <li class="text-white"> <i class="icons icon-phone"></i> <a
                                            href="tel:+910000000000">+91 0000000000</a></li>
                                    <li class="text-white"> <i class="icon-envelope-letter icons"></i> <a
                                            href="#"   style="font-family: Helvetica" >modento@gmail.com</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="header_container justify-content-between align-items-center position-relative">
                            <div class="canvas_open">
                                <a href="javascr    ipt:void(0)"><i class="ion-navicon"></i></a>
                            </div>
                            <div class="header_logo">
                                <a class="items-center justify-center" href="#"><center><img src="home/uthr/assets/img/logo/logo.png" alt=""></center></a>
        ...
        <div class="main_menu d-none d-lg-block">
            <nav>
                <ul class="d-flex">
                    <li><a class="active" href="{{route('home.userpage')}}">Home</a> </li>
                    <li><a href="/womenpage">New <i class="icon icon-arrow-down"></i></a>
                        <ul class="sub_menu">
                            <li><a href="/womenpage">Arrivals</a></li>
                            <li><a href="/womenpage">Hot</a></li>
                        </ul>
                    </li>
                    <li><a href="/womenpage" >Men <i class="icon icon-arrow-down"></i></a>
                        <ul class="sub_menu">
                            <li><a href="/womenpage">T-shirts</a></li>
                            <li><a href="/womenpage">Pants</a></li>
                        </ul>
                    </li>
                    <li><a href ="/womenpage">Women <i class="icon icon-arrow-down"></i></a>
                        <ul class="sub_menu">
                            <li><a href="/womenpage">kurties</a></li>
                            <li><a href="/womenpage">pants</a></li>
                        </ul>
                    </li>
                    <li><a href="/womenpage">Kids <i class="icon icon-arrow-down"></i></a>
                        <ul class="sub_menu">
                            <li><a href="/womenpage">Cart Pages</a></li>
                            <li><a href="/womenpage">Checkout Pages</a></li>
                        </ul>
                    </li>
                    <li><a href="/womenpage">Season <i class="icon icon-arrow-down"></i></a>
                        <ul class="sub_menu">
                            <li><a href="/womenpage">Blog Pages</a></li>
                            <li><a href="/womenpage">Blog Details</a></li>
                        </ul>
                    </li>
                    <li><a href="/womenpage">sale</a></li>
...
<div class="main-body">
            ...
            <div class="row">
                    ...
                    <div class="product_zoom_gallery">
                       <div class="zoom_gallery_inner d-flex">
                           <div class="zoom_tab_img">
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product1.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product2.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product3.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product4.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product1.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product2.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product3.png" alt="tab-thumb"></a>
                                <a class="zoom_tabimg_list" href="javascript:void(0)"><img src="home/uthr/assets/img/product/small-product/product4.png" alt="tab-thumb"></a>
                           ...
                           <div class="product_zoom_main_img">
                                <div class="product_zoom_thumb">
                                    <img data-image="home/uthr/assets/img/product/big-product/product1.png" src="home/uthr/assets/img/product/big-product/product1.png" alt="">
                                </div>
                                <div class="product_zoom_thumb">
                                    <img data-image="home/uthr/assets/img/product/big-product/product1.png" src="home/uthr/assets/img/product/big-product/product1.png" alt="">
                                </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product_d_right">
                       <form action="#">
							<p class="product-brand">Adidas Originals</p>
                            ...
                            <div class="product_variant">
                                <div class="filter__list widget_color align-items-center">
                                    ...
                                    <div class="product-color mt-10px">
										<ul class="d-flex">
										   <li>
												<img src="home/uthr/assets/img/product/small-product/product1.png" width="68" height="98" class="selected">
											</li>
											<li>
												<img src="home/uthr/assets/img/product/small-product/product2.png" width="68" height="98">
											</li>
											<li>
												<img src="home/uthr/assets/img/product/small-product/product3.png" width="68" height="98">
											</li>
											<li>
												<img src="home/uthr/assets/img/product/small-product/product4.png" width="68" height="98">
											</li>
										</ul>
									</div>
                                </div>
                                ...
                                <div class="variant_quantity_btn d-flex">
                                    ...
                                    <a href="/add_to_cart"  class="button btn btn-primary"><i class="ion-android-add"></i> Add To Cart</a>
							...
							<div class="delivery-details-report">
								<div class="delivery-inner-block">
									<div class="truck-block">
										<p><svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" aria-labelledby="expresslevering-:R1a:" class="zds-icon RC794g X9n9TI DlJ4rT _5Yd-hZ HlZ_Tf I_qHp3" focusable="false" aria-hidden="true" role="img"><title id="expresslevering-:R1a:">Expresslevering</title><path d="M2.231 8.25h2.282a.75.75 0 0 0 0-1.5H2.231a.75.75 0 0 0 0 1.5zm2.266 3a.75.75 0 0 0 0-1.5H.753a.75.75 0 0 0 0 1.5h3.744zm.016 3.001a.75.75 0 0 0 0-1.5H2.21a.75.75 0 0 0 0 1.5h2.303z"></path><path d="m23.81 11.501-3.368-3.738a.754.754 0 0 0-.557-.248h-3.378V4.497a.75.75 0 0 0-.75-.75H3.711a.75.75 0 0 0 0 1.5l11.298-.004.003 10.513-4.953.004c-.519-.897-1.478-1.508-2.588-1.508s-2.07.61-2.588 1.508H3.712a.75.75 0 1 0 0 1.5h.76a2.999 2.999 0 0 0 5.998 0h5.276l.76.003a2.999 2.999 0 0 0 5.997 0h.749a.75.75 0 0 0 .75-.75v-4.51a.751.751 0 0 0-.193-.502zm-16.338 7.25a1.5 1.5 0 1 1 0-2.999 1.5 1.5 0 0 1 0 2.999zm12.032 0a1.5 1.5 0 1 1 0-2.999 1.5 1.5 0 0 1 0 2.999zm2.998-2.988h-.408a2.987 2.987 0 0 0-2.59-1.511 2.987 2.987 0 0 0-2.59 1.511h-.402l-.003-6.748h3.042l2.95 3.278v3.47z"></path></svg></p>
										<p>2-4 Working Days</p>
										<p>Standard Delivery</p>
										<p><a href="#">Free For Orders Over £35.00*</a></p>
									</div>
									<div class="return-block"><svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" class="zds-icon RC794g X9n9TI DlJ4rT _5Yd-hZ SpRgR2 HlZ_Tf I_qHp3" focusable="false" aria-hidden="true"><path d="M14.25 4.33H1.939l3.056-3.055A.75.75 0 0 0 3.934.215L.658 3.49a2.252 2.252 0 0 0 0 3.182l3.276 3.275a.75.75 0 0 0 1.06-1.06L1.94 5.83h12.31c4.557 0 8.251 3.694 8.251 8.25s-3.695 8.42-8.251 8.42h-12a.75.75 0 0 0 0 1.5h12c5.385 0 9.75-4.534 9.75-9.919s-4.365-9.75-9.75-9.75z"></path></svg> 100 Day Return Policy</div>
								</div>
							</div>
							<div id="accordion">
							  ...
							  <div class="card">
								<div class="card-header">
								  <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseOne">
									Material & Care <span><i class="fa fa-angle-down" aria-hidden="true"></i></span>
								  </a>
								</div>
								<div id="collapseOne" class="collapse" data-bs-parent="#accordion">
								  <div class="card-body">
                                    <table style="border-collapse: collapse; border: 1px solid black; text-align: center; padding: 10px;">
                                        <thead>
                                            <tr>
                                                <th style="border: 1px solid black; text-align: center; padding: 10px;">Specification</th>
                                                <th style="border: 1px solid black; text-align: center; padding: 10px;">Material </th>
                                                <th style="border: 1px solid black; text-align: center; padding: 10px;">Care </th>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="border: 1px solid black; text-align: center; padding: 10px;">Summer Dress</td>
                                                <td style="border: 1px solid black; text-align: center; padding: 10px;">Cotton blend</td>
                                                <td style="border: 1px solid black; text-align: center; padding: 10px;"><ul style="text-align: left">
							  ...
							  <div class="card">
								<div class="card-header">
								  <a class="collapsed btn" data-bs-toggle="collapse" href="#collapseTwo">
									Details <span><i class="fa fa-angle-down" aria-hidden="true"></i></span>
								  </a>
								</div>
								<div id="collapseTwo" class="collapse" data-bs-parent="#accordion">
								  <div class="card-body">
                                    <ul>
                                        ...
                                        <li>Design: Logo Script Print</li>
                                        <li>Color: Navy</li>
                                    </ul>
							  ...
							  <div class="card">
                                     ...
                                     <ul>
                                        <li>Size and Fit:
                                            <ul>
                                                ...
                                                <li>Model's height: 6'2" (187 cm)</li>
								...
								<div class="card legal-concern">
									<p><a href="#"><i class="fa fa-flag-o" aria-hidden="true"></i> Report a Legal Concern</a></p>
								</div>
							</div>
                        </form>
                    </div>
    ...
    <!--product area start-->
    <section class="product_area related_products mb-50 product_detail_slider" >
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="top-header mb-30">
                        <h2>Mini Moda </h2>
						<p> <span><a href="#">See More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></span></p>
                    </div>
                </div>
            </div>
                ...
                <div class=" product_slick slick_slider_activation" data-slick='{
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                         ...
                         <a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-1.png" alt="consectetur">
                                    </a>
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                        <a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-3.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                      <a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-2.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-4.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                       <a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-5.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
                     <a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/kids-6.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
                ...
                <div class=" product_slick slick_slider_activation" data-slick='{
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/women-1.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/women-2.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/women-3.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/women-4.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/women-5.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
                ...
                <div class=" product_slick slick_slider_activation" data-slick='{
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-1.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-2.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-3.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-4.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-5.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
...
<a class="btn btn-primary" href="/add_to_cart" data-tippy="Move To Bag" data-tippy-inertia="true" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-placement="top">Add To Cart</a>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <article class="single_product">
                            <figure>
                                <div class="product_thumb">
<a href="#" >                                        <img class="primary_img" src="home/uthr/assets/img/product/men-6.png" alt="consectetur">
                                    </a>
                                    <div class="product_action">
                                        <ul>
                                            <li class="wishlist"><a href="#" data-tippy="Wishlist" data-tippy-inertia="true" data-tippy-delay="50"
